...
/* ====================================== */
require_once("includes/rc-functions.php");
...
/* ============================ */
function rc_sms_languages() {
    load_plugin_textdomain('ringcentral-sms', false, 'ringcentral-sms/languages');    
}

add_action('plugins_loaded', 'rc_sms_languages');
...
function rc_config_page() {
    ...
    <div class="wrap">
        ...
        <?php require_once(RINGCENTRAL_PLUGINDIR . "includes/rc-config-page.php"); ?>
...
function rc_send_sms_page() {
    ...
    <div class="wrap">
        ...
        <?php require_once(RINGCENTRAL_PLUGINDIR . "includes/rc-send-sms-page.php"); ?>
...
/* ============================================= */
function rc_install() {
    require_once(RINGCENTRAL_PLUGINDIR . "includes/rc-install.php");
}
/* ========================================= */
/* Create default pages on plugin activation */
/* ========================================= */
function rc_activation(){
    require_once(RINGCENTRAL_PLUGINDIR . "includes/rc-activation.php");
}
